// Options page JavaScript for MailSense Extension
...
async function loadTabsList() {
    try {
        const data = await chrome.storage.local.get(['mailSenseTabs']);
        const tabs = data.mailSenseTabs || [];
...
console.log('MailSense Options: Script loaded');