    ...
    function attachEventListeners() {
        try {
                ...
                tab.addEventListener('drop', (e) => {
                    if (isEditMode && draggedTabIndex !== null) {
                        ...
                        if (draggedTabIndex !== dropIndex) {
                            ...
                            chrome.storage.local.set({ mailSenseTabs: currentTabs }, () => {
                                refreshTabsDisplay();
                            });
                        }
                    }
            ...
            console.error('MailSense: Error attaching event listeners:', error);
        }
    }
    ...
    function applyGmailFilter(label) {
        try {
            ...
            if (window.location.hash !== path) {
                ...
                console.log(`MailSense: Navigated to ${path}`);
            }
        } catch (error) {
            console.error('MailSense: Error applying filter:', error);
        }
    }
    ...
    function updateEmailCounts() {
        try {
            ...
            console.error('MailSense: Error updating counts:', error);
        }
    }
    ...
    function addNewTab(name, label, icon) {
        try {
            ...
            console.error('MailSense: Error adding new tab:', error);
        }
    }
    ...
    function openSettings() {
        try {
            ...
            console.error('MailSense: Error opening settings:', error);
        }
    }
    ...
    function addLabelMenuIntegration() {
        try {
            ...
            console.error('MailSense: Error adding label menu integration:', error);
        }
    }
    ...
    function addTabOptionToLabelMenu(menu) {
        ...
        try {
            ...
            console.error('MailSense: Error adding tab option to menu:', error);
        }
    }
    ...
    function createTabFromLabel(labelName) {
        try {
            ...
            console.error('MailSense: Error creating tab from label:', error);
        }
    }
        ...
        try {
            ...
            const observer = new MutationObserver(() => {
                ...
                if (!document.getElementById('gmail-tabs-container')) {
                    console.log('MailSense: Tabs disappeared, re-injecting...');
                    isInjected = false;
            ...
            console.error('MailSense: Error setting up observer:', error);
        }
    }
    ...
    async function initialize() {
        try {
            console.log('MailSense: Initializing enhanced tabs with AI integration...');
            await loadSavedTabs();
            ...
            console.error('MailSense: Initialization error:', error);
        }
    }
